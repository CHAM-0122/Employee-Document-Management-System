...
export async function PATCH(
  ...
  if (shouldUseMockData()) {
    const updated = saveMockEmploymentContract(token, parsed.data);
    if (!updated) {
  ...
  await savePublicEmploymentContract(intake.id, parsed.data);
